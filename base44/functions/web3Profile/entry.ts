...
const EDITABLE = ['display_name', 'avatar_url', 'banner_url', 'bio', 'ens_name', 'twitch_username', 'twitter_handle', 'connections', 'broadcast_all', 'onboarding_completed', 'bound_domain'];
