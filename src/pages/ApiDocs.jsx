...
import FileStructureTab from "@/components/apidocs/FileStructureTab";
  ...
  return (
    <div className="p-6 lg:p-8 max-w-5xl mx-auto">
      ...
      <div className="flex gap-1 bg-secondary rounded-xl p-1 mb-6 w-fit">
        {[{ id: "endpoints", label: "API Endpoints" }, { id: "architecture", label: "Backend Structure" }, { id: "files", label: "File Structure" }, { id: "wfh", label: "Work for Hire" }].map(t => (
