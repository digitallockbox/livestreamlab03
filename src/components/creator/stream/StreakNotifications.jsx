...
import { Bell, Flame, X, CheckCheck, Loader2 } from "lucide-react";
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="hidden sm:inline">Streak Alerts</span>
        {unread > 0 && (
          ...
          <div className="absolute right-0 mt-2 w-80 max-w-[calc(100vw-2rem)] z-40 rounded-xl border border-border bg-popover shadow-xl overflow-hidden">
            <div className="flex items-center justify-between px-4 py-3 border-b border-border">
              <div className="flex items-center gap-2">
                ...
                <span className="font-display font-semibold text-sm">Streak Milestones</span>
              </div>
            ...
            <div className="max-h-80 overflow-y-auto divide-y divide-border/50">
              {recent.length === 0 ? (
                <div className="px-4 py-8 text-center">
                  ...
                  <p className="text-xs text-muted-foreground mt-1">Watch 7 days in a row to unlock your first!</p>
                </div>
              ) : recent.map((n) => (
